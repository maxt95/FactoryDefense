...
final class BootstrapInventoryTests: XCTestCase {
    func testBootstrapStartingResourcesMatchDifficulty() {
        ...
        XCTAssertEqual(easy["turret_core", default: 0], 2)
        XCTAssertEqual(easy["wall_kit", default: 0], 8)
        ...
        XCTAssertEqual(normal["turret_core", default: 0], 1)
        XCTAssertEqual(normal["wall_kit", default: 0], 6)
        ...
        XCTAssertEqual(hard["plate_steel", default: 0], 6)
        XCTAssertEqual(hard["gear", default: 0], 3)
        XCTAssertEqual(hard["circuit", default: 0], 2)
        XCTAssertEqual(hard["turret_core", default: 0], 1)
        XCTAssertEqual(hard["wall_kit", default: 0], 3)
