...
- 2026-02-18: Removed remaining non-HQ global-inventory compatibility fallback from runtime logic; reserve checks now read live physical stock aggregation and HQ storage remains simulation truth.
- 2026-02-18: Removed remaining extraction compatibility surfaces from simulation command/state/event enums and dropped legacy `waves.json` array-shape loading fallback in content loader.
